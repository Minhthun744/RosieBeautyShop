...
import com.minhthuong.productcatalogservice.service.OrderServiceClient;
...
public class ProductServiceImpl implements ProductService {
    ...
    public List<Product> searchProducts(String name, Long categoryId, BigDecimal minPrice, BigDecimal maxPrice,
        ...
        try {
            ...
            return productRepository.searchProducts(name, categoryId, minPrice, maxPrice, sort);
        } catch (Exception e) {
    ...
    private boolean isValidSortField(String field) {
        return field != null && (field.equals("id") ||
                field.equals("productName") ||
                field.equals("price") ||
                field.equals("categoryId"));
    }
    ...
    public boolean canDeleteProduct(Long productId) {
        boolean hasOrder = orderServiceClient.existsOrderWithProductId(productId);
        return !hasOrder;
    }
}

...
import com.minhthuong.orderservice.repository.OrderRepository;
...
public class OrderServiceImpl implements OrderService {
    ...
    @Override
    public boolean existsOrderWithProductId(Long productId) {
        return orderRepository.existsByItemsProductId(productId);
    }
}

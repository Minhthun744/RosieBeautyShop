...
import com.minhthuong.orderservice.domain.*;
import com.minhthuong.orderservice.feignclient.UserClient;
...
import com.minhthuong.orderservice.service.PayPalService;
import com.minhthuong.orderservice.utilities.OrderUtilities;
...
import com.minhthuong.orderservice.repository.UserRepository; // Thêm dòng này
@RestController
@RequestMapping("/shop/order")
public class OrderController {

    // API kiểm tra sản phẩm có nằm trong đơn hàng không (cho Feign client)
    @GetMapping("/exists-by-product")
    public boolean existsOrderWithProductId(@RequestParam("productId") Long productId) {
        return orderService.existsOrderWithProductId(productId);
    }

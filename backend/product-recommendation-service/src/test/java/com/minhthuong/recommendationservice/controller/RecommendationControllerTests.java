package com.minhthuong.recommendationservice.controller;

import com.fasterxml.jackson.databind.ObjectMapper;
import com.fasterxml.jackson.databind.ObjectWriter;
import com.fasterxml.jackson.databind.SerializationFeature;
import com.minhthuong.recommendationservice.feignClient.ProductClient;
import com.minhthuong.recommendationservice.feignClient.UserClient;
...
import com.minhthuong.recommendationservice.model.User;
import com.minhthuong.recommendationservice.service.RecommendationService;
...
public class RecommendationControllerTests {
    ...
    public void save_recommendations_controller_should_return201_when_user_is_saved() throws Exception {
        ...
        mockMvc.perform(post("/{userId}/recommendations/{productId}", USER_ID, PRODUCT_ID)
                .param("rating", RATING.toString()).content(requestJson).contentType(MediaType.APPLICATION_JSON_UTF8))

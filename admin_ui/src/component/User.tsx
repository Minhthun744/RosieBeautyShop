    ...
    return (
        <Create>
            <SimpleForm onSubmit={handleSubmit}>
                ...
                <TextInput source="userPassword" label="Mật khẩu" validate={[required()]} type="password" />
...
const result = await dataProvider.update('users', { id: parseInt(id), data: userData, previousData: record });
    ...
    return (
        <Edit mutationMode="pessimistic">
            <SimpleForm onSubmit={handleSubmit}>
                ...
                <TextInput source="userName" label="Tên đăng nhập" validate={[required()]} />
                <TextInput source="userPassword" label="Mật khẩu mới (để trống nếu không đổi)" type="password" />
